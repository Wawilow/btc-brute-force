...
def main():
    global num_global
    window, settings, generator = None, load_settings(SETTINGS_FILE, DEFAULT_SETTINGS ), False
    while True:
        if window is None:
        ...
        if generator:
            ...
            print("Num: "+str(num_global)+"\n"+
                  'mnemonic and passphrase:   '+str(mnemonic)+ ' ' +str(passphrase)+'\n'+
